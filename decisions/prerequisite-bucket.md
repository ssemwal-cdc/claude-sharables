...
Rejected reasons to split: a different topic, a different department, a different data domain, a different dashboard, a feeling of being unrelated, more than one skill in a plugin, and folder tidiness.
