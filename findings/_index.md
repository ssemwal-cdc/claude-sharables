...
| pending | `review-only-dashboards-measured` | Review-only dashboards measured | observed | 2026-09-18 | A reviewer sees the whole queue, with no control they cannot use. |
