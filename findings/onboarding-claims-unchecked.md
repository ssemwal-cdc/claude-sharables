...
What is genuinely checkable without a browser is now checked. The file decodes as UTF-8, carries a doctype and a character-set meta tag, and closes its root element. It defines every custom property it uses on a bare root selector.
