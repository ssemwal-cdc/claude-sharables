...
Change orders were structurally absent. That step is the only place they can be identified, and the transaction table cannot be queried for their pending status.
