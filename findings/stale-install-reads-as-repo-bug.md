...
A report said that `publish_dashboard.py` hardcoded the change order type that returns a 400 response. The repo had shipped the working type the day before. Both observations were correct.
