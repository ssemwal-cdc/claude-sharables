...
The bar sits near the bottom of a long document. It is simply not on screen while you work the queue. The header mirror is far above the viewport in the same arrangement.
...
- The fix is `F‹tiled-sentinels-beat-single-sentinel›`, tiled sentinels track
  the band.
