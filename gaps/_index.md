...
| pending | `execute-button-blocked-state-unseen` | Execute button blocked state unseen | unobserved | 2026-09-16 | A blocked execute button reads as blocked, not as broken. |
