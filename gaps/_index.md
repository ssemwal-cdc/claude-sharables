...
| G3 | `netsuite-notes-page` | NetSuite notes page unseen | unobserved | 2026-08-15 | An approval note lands where the auditor will look for it. |
...
| G7 | `po-crosscheck-unobserved` | PO cross-check fixed, unobserved | unobserved | 2026-08-20 | A correctly coded bill is never flagged as coded to the wrong purchase order. |
...
| G10 | `procore-scheduled-prompt-unfired` | Procore scheduled prompt unfired | unobserved | 2026-08-24 | A scheduled Procore window reviews the queue once, not repeatedly. |
